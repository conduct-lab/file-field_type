...
class FileTableBuilder extends TableBuilder
{
    public function __construct(PreferenceRepositoryInterface $preferences, Table $table)
    {
        ...
        $default_order_by = $preferences->value('anomaly.field_type.file::default_order_by', 'updated_at');
        $default_order_direction = $preferences->value('anomaly.field_type.file::default_order_direction', 'desc');
